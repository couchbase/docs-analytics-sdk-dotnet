= Couchbase Analytics .NET SDK Documentation
...
It follows the https://docs.couchbase.com/analytics-dotnet-sdk/1.1/project-docs/compatibility.html#api-version[analytics SDK 1.1 API].
...
| `name_platform:` | Allows us to name the SDK within shared content (*.NET*).

| `name-sdk:` | Allows us to name the SDK within shared content (*.NET Analytics SDK*).
