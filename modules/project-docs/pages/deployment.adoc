...
This not only contains the latest security updates and bug fixes, but will be compatible with the latest Enterprise Analytics release -- Capella always runs a recent version of Enterprise Analytics.


TIP: Connecting to a xref:enterprise-analytics:intro:intro.adoc[_Capella_ Analytics] cluster from .NET is not currently possible.
