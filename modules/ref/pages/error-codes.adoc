= Error Messages
:description: The standardized error codes returned by the Analytics .NET SDK, from Capella connection to {sqlpp} query.
...
The {name-sdk} passes through the Analytics error codes from Enterprise Analytics.
